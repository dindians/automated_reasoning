...
internal object Expressions {
    ...
    val `1 * x` = Expression.Mul(Expression.Const(1), Expression.Var("x"))
    val `2 * 3` = Expression.Mul(Expression.Const(2), Expression.Const(3))
    val `3 * 2` = Expression.Mul(Expression.Const(3), Expression.Const(2))
    val `2 * 3 + 4` = Expression.Add(Expression.Mul(Expression.Const(2), Expression.Const(3)), Expression.Const(4))
    val `2 * (3 + 4)` = Expression.Mul(Expression.Const(2), Expression.Add(Expression.Const(3), Expression.Const(4)))
    val `2 * 3 * 4` = Expression.Mul(Expression.Const(2), Expression.Mul(Expression.Const(3), Expression.Const(4)))
